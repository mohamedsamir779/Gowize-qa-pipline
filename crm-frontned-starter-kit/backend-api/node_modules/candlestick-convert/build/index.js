...
exports.batchCandleArray = (candledata, baseFrame = 60, newFrame = 300, includeOpenCandle = false) => {
    const result = [];
    baseFrame *= 1000;
    newFrame *= 1000;
    ...
    for (let i = 0; i < candledata.length; i++) {
        ...
        // New Candle
        if (candle[OHLCVField.TIME] - (candle[OHLCVField.TIME] % newFrame) !==
            timeOpen) {
...
exports.batchCandleJSON = (candledata, baseFrame = 60, newFrame = 300) => {
    ...
    const batchedOhlcvArray = exports.batchCandleArray(ohlcvArray, baseFrame, newFrame);
...
exports.batchTicksToCandle = (tradedata, interval = 60, includeOpenCandle = false, filterFn) => {
...
exports.ticksToTickChart = (tradedata, tickSize = 5) => {
    let result = [];
...
exports.default = {
    array: exports.batchCandleArray,
    json: exports.batchCandleJSON,
    trade_to_candle: exports.batchTicksToCandle,
    tick_chart: exports.ticksToTickChart,
};
