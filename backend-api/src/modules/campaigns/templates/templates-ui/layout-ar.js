...
<body class="respond" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style={{ direction: 'rtl', textAlign: 'right' }}>
                        ...
                        <td align="">
                            ...
                            <tr>
                                ...
                                <td align="right" style="padding-left: 20px ">
                                        <div style="width: 150px; height: 56px; text-align: right;margin-right: auto;irection: 'rtl'; textAlign: 'right'">
...
<!-- main section -->
<table border="0" width="100%" cellpadding="0" cellspacing="0" bgcolor="ffffff" style={{ direction: 'rtl', textAlign: 'right' }}>

    <tr>
        <td align="center" style={{ direction: 'rtl', textAlign: 'right' }} >
...
تحذير عالي لمخاطر الاستثمار: ينطوي تداول العملات الأجنبية على هامش على درجة عالية من المخاطرة، وقد لا يكون مناسبًا لجميع المستثمرين. ميزة الرافعة المالية العالية يمكن أن تعمل ضدك مثلما تكون لصالحك . فقبل أن تقرر تداول العملات الأجنبية ، يجب أن تفكر بعناية في أهدافك الاستثمارية ومستوى خبرتك ورغبتك في المخاطرة. هناك احتمال أن تتعرض لخسارة بعض أو كل استثماراتك الأولية ، وبالتالي يجب ألا تستثمر أموالًا لا يمكنك تحمل خسارتها. يجب أن تكون على دراية بجميع المخاطر المرتبطة بتداول العملات الأجنبية ، وطلب المشورة من مستشار مالي مستقل إذا كان لديك أي شكوك
                                ...
                                <span style="color: #333333;  padding-bottom: 10px; display: block">
                                     انقر <a href="${keys.cpUrl}/unsubscribe/?email={{email}}">هنا</a> لإلغاء الإشتراك في البريد التسويقي
                                </span>
                            </div>
                        </td>
                    </tr>
