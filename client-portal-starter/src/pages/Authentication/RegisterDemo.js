...
import { checkUserExist } from "store/general/auth/checkEmail/actions";
...
const Register = props => {
  ...
  return (
    <React.Fragment>
      ...
      <MetaTags>
        <title>{t("Register Demo")} | {content.clientName}</title>
      </MetaTags>
                  ...
                  <div className="d-flex flex-column h-100">
                    ...
                    <div className="auth-content my-auto">
                      <div className="text-center mb-4 mb-md-3">
                        <h5 className="mb-0">{t("Register Demo Account")}</h5>
                      </div>
                        ...
                        {({ values, setFieldValue }) => (
                          <Form tag={FormikForm}>
                            ...
                            <div className="mb-3 text-right">
                              {loading ? <Spinner className="ms-2 text-center" color="primary" /> : <Button disabled={checkEmail} className="text-center" color="primary" type="submit">Register</Button>}
                            </div>
                            {user && user ? (
                              <Alert color="success">
